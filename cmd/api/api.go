...
func main() {
	...
	flag.StringVar(&cfg.db.dsn, "dsn", "hiro:Aa123456@tcp(localhost:3306)/widgets?parseTime=true&tls=false", "DSN")
	flag.StringVar(&cfg.smtp.host, "smtphost", "sandbox.smtp.mailtrap.io", "smtp host")
	flag.IntVar(&cfg.smtp.port, "smtpport", 587, "smtp port")
	flag.StringVar(&cfg.smtp.username, "smtpuser", "68d02aa45c443e", "smtp username")
	flag.StringVar(&cfg.smtp.password, "smtppass", "0c7252b100caaa", "smtp password")
	flag.StringVar(&cfg.secretKey, "secret", "ZW5JRHKXMkiBU89xCYjH5TaEqIz6LLew", "secret key")
